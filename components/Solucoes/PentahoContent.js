                ...
                <div className="container">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="services-details-image">
                                    <img src={require("../../images/service-details/pentaho1.jpg")} alt="Pentaho" />
                                </div>
                            </div>
                        </div>
                        <div className="row" style={{paddingBottom:"2em"}}>
                            <div className="col-6" style={{display:"flex !important"}}>
                                <img src={require("../../images/service-details/pentaho2.png")} alt="Pentaho" style={{width:"50px", height:"50px", marginRight:"2em"}}/>
                                <h6>Consultoria Especializada Pentaho</h6>
                            </div>
                            <div className="col-6" style={{display:"flex !important"}}>
                                <img src={require("../../images/service-details/pentaho3.png")} alt="Pentaho" style={{width:"50px", height:"50px", marginRight:"2em"}}/>
                                <h6>Otimização e Governança em DW / BI</h6>
                            </div>
                        </div>
                        <div className="row" style={{paddingBottom:"2em"}}>
                            <div className="col-6" style={{display:"flex !important"}}>
                                <img src={require("../../images/service-details/pentaho4.png")} alt="Pentaho" style={{width:"50px", height:"50px", marginRight:"2em"}}/>
                                <h6>Suporte Profissional Pentahoe</h6>
                            </div>
                            <div className="col-6" style={{display:"flex !important"}}>
                                <img src={require("../../images/service-details/pentaho5.png")} alt="Pentaho" style={{width:"50px", height:"50px", marginRight:"2em"}}/>
                                <h6>Implementação de BI Embarcado</h6>
                            </div>
                        </div>
                        <div className="row" style={{paddingBottom:"2em"}}>
                            <div className="col-6" style={{display:"flex !important"}}>
                                <img src={require("../../images/service-details/pentaho6.png")} alt="Pentaho" style={{width:"50px", height:"50px", marginRight:"2em"}}/>
                                <h6>Desenvolvimento de Arquitetura de Dados</h6>
                            </div>
                            <div className="col-6" style={{display:"flex !important"}}>
                                <img src={require("../../images/service-details/pentaho7.png")} alt="Pentaho" style={{width:"50px", height:"50px", marginRight:"2em"}}/>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col md-4">
                            <img src={require("../../images/service-details/pentaho8.jpg")} alt="Pentaho" style={{width:"auto", height:"400px", marginleft:"0em", marginright:"0em"}}/>
                        </div>
                    </div>
                    <div className="row align-items-center">
                        <div className="col md-4">
                            <img src={require("../../images/service-details/pentaho9.jpg")} alt="Pentaho" style={{width:"auto", height:"400px", marginleft:"0em", marginright:"0em"}}/>
                        </div>
                        <div className="col md-8">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col md-4">
                            <img src={require("../../images/service-details/pentaho10.jpg")} alt="Pentaho" style={{width:"auto", height:"400px", marginleft:"0em", marginright:"0em"}}/>
                        </div>
                    </div>
                    <div className="row align-items-center">
                        <div className="col md-4">
                            <img src={require("../../images/service-details/pentaho11.jpg")} alt="Pentaho" style={{width:"auto", height:"400px", marginleft:"0em", marginright:"0em"}}/>
                        </div>
                        <div className="col md-8">
