                ...
                <div className="container">
                    <div class="py-5">
                        <div class="row justify-content-center text-center py-3">
                            ...
                            <h1 class="display-4">Oferecemos soluções para problemas de dados, inclusive o seu.</h1>
                            <p class="lead mb-4">Reunimos competências que combinam estratégias de Negócios e Tecnologia avançadas de Big Data, Business Intelligence, Analytics e Inteligência artificial para resolver problemas reais do mercado.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row py-5">
                        <div className="col-12 col-md-3 mb-4 mb-md-0">
                            ...
                            <div class="small">
                                ...
                                <Link href="/big-data">
                                    <a class="weight-500 action-link">
                                        <span>Saiba mais
